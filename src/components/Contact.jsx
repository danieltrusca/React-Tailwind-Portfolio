      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="subtitle">
            ...
            unde, temporibus quisquam nemo suscipit ullam debitis at, totam
            tempora excepturi quae aspernatur veniam corrupti dignissimos?
            Accusantium quis minus quibusdam vero!
          </p>
        </div>
